        ...
        <div className={s.wrapper}>
            <div className={s.header}>
                <div className={s.container_img}>
                    <img src="https://plant-box.pro/sites/all/themes/photography_zymphonies_theme/images/logo-white.png" alt=""/>

                </div>
                <div className={s.menu}>
                    <select name="region" id="input-select" className={s.select}>
